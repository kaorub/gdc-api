describe('PromiseStack', function() {
    ...
    it('should have then method', function() {
        expect(this.instance.then).to.be.a(Function);
    });
    ...
    it('should resolve after the last chained method resolves', function(done) {
        ...
        this.instance.methodA().then(spy).done(done);
    ...
    it('should reject after the last chained method rejects', function(done) {
        ...
        this.instance.methodA().then(null, spy).done(done);
    ...
    it('should resolve sequentially', function(done) {
        ...
        this.instance.methodA().then(spyA);
        this.instance.methodB().then(spyB);
    ...
    it('should chain arbitrary method', function(done) {
        var deferred = q.defer();
        var spy = sinon.spy();
        ...
        this.instance.methodA().chain(spy).then(function() {
            expect(this.instance.privateMethodA.calledBefore(spy)).to.be(true);
        }.bind(this)).done(done);
